...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Sci Fi London Audio Player. You can say, play the audio to begin the story.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Sci Fi London Audio Player. You can say, play the audio to begin the story.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Sci Fi London Audio Player. You can say, Next or Previous to navigate through the playlist. ' +
